...
export function AuthForm(props: AuthProps) {
    ...
    return (
        <div className="my-auto flex items-center justify-center gap-4 bg-hog-bg px-4">
            <div className="hidden lg:block aspect-square w-full max-w-md overflow-hidden rounded-2xl">
                <img
